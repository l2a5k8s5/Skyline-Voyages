          ...
          <div className="booking__bottom">
            <ListGroup>
              ...
              <ListGroupItem className="border-0 px-0">
                <h5>Hotel Type</h5>
                <span>
                  {booking.hotelType === 'fiveStar' ? '5 Star' : '3 Star'} - $ 
                  {booking.hotelType === 'fiveStar'
                    ? hotelOptions.fiveStar || 0
                    : hotelOptions.threeStar || 0}
                </span>
              </ListGroupItem>
              <ListGroupItem className="border-0 px-0">
                <h5>Flight Class</h5>
                <span>
                  {booking.flightClass === 'economy' ? 'Economy' : 'Business'} - $
                  {booking.flightClass === 'economy'
                    ? flightOptions.economy || 0
                    : flightOptions.business || 0}
                </span>
              </ListGroupItem>
